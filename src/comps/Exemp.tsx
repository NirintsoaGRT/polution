...
const Exemp = () => {
  return (
    <StyledWrapper>
      <div className="card w-[33vw]">
        <div className="wrap">
          <div className="terminal">
            <hgroup className="head">
              <p className="title">
                <svg fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" height="16px" width="16px">
            ...
            <div className="body">
              <pre className="pre">{"          "}<code>-&nbsp;</code>{"\n"}{"          "}<code>npx&nbsp;</code>{"\n"}{"          "}<code data-cmd="Profile : Mr Nirintsoa" className="cmd" />{"\n"}{"        "}</pre>
            </div>
          </div>
        </div>
      </div>
