...
const Loder = () => {
  return (
    ...
    <div className="relative w-8 h-15 flex flex-col items-center earth">
      <div className="earth-loader w-8 h-8 bg-[#3344c1] relative overflow-hidden rounded-full shadow-[inset_0_0.125rem_rgba(255,255,255,0.25),inset_0_-0.125rem_rgba(0,0,0,0.25)] border border-white animate-[startround_1s_1]">
        <svg className="absolute -bottom-1 w-7 h-auto animate-[round1_5s_infinite_linear_0.75s]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
        ...
        <svg className="absolute -top-3 w-7 h-auto animate-[round1_5s_infinite_linear]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
        ...
        <svg className="absolute -top-2.5 w-7 h-auto animate-[round2_5s_infinite_linear]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
        ...
        <svg className="absolute -bottom-1.5 w-7 h-auto animate-[round2_5s_infinite_linear_0.75s]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
